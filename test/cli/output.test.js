...
describe('CLI Output Utils', () => {
    ...
    describe('formatStatus', () => {
        test('CLI-OUTPUT-STATUS-001: unplayed应返回"未看"', () => {
            expect(formatStatus('unplayed')).toBe('未看');
        });

        test('CLI-OUTPUT-STATUS-002: playing应返回"观看中"', () => {
            expect(formatStatus('playing')).toBe('观看中');
        });
